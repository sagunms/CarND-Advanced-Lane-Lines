...
class BinaryMasking():
    ...
    def __init__(self, img):
        # Colour masking
        img_masked_y_channel = self.colour_filter_y_channel(img, (110, 255))
        img_masked_v_channel = self.colour_filter_v_channel(img, (10, 110))

        # Sobel edge masking
        img_abs_x = self.sobel_gradient_xy(img, 'x', (13, 230))
        img_g_mag = self.sobel_gradient_magnitude(img, 3, (20, 150))
        img_d_mag = self.sobel_gradient_direction(img, 3, (0.5, 1.0))
